...
struct MicroSpinLock {
  ...
  bool try_lock() noexcept {
    ...
    annotate_rwlock_try_acquired(this, annotate_rwlock_level::wrlock, ret,
                                 __FILE__, __LINE__);
    return ret;
  }
  ...
  void lock() noexcept {
    ...
    annotate_rwlock_acquired(this, annotate_rwlock_level::wrlock, __FILE__,
                             __LINE__);
  }

  void unlock() noexcept {
    assert(payload()->load() == LOCKED);
    annotate_rwlock_released(this, annotate_rwlock_level::wrlock, __FILE__,
                             __LINE__);
...
private:
  ...
  uint8_t xchg(uint8_t newVal) noexcept {
    return std::atomic_exchange_explicit(payload(), newVal,
