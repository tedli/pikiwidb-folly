...
template <class... Args> std::system_error makeSystemError(Args &&...args) {
...
// on error.
template <class... Args> void checkPosixError(int err, Args &&...args) {
...
template <class... Args> void checkKernelError(ssize_t ret, Args &&...args) {
...
// on error.
template <class... Args> void checkUnixError(ssize_t ret, Args &&...args) {
...
// freopen, tmpfile, etc.
template <class... Args> void checkFopenError(FILE *fp, Args &&...args) {
