...
#define FOLLY_GFLAGS_DEFINE_FALLBACK_(_type, _shortType, _name, _default,      \
                                      _description)                            \
  namespace fL##_shortType {                                                   \
...
#else
#define FOLLY_GFLAGS_DEFINE_uint32(_name, _default, _description)              \
  FOLLY_GFLAGS_DEFINE_FALLBACK_(::std::uint32_t, U32, _name, _default,         \
                                _description)
#endif
...
#define FOLLY_GFLAGS_DEFINE_int32(_name, _default, _description)               \
  FOLLY_GFLAGS_DEFINE_FALLBACK_(::std::int32_t, I, _name, _default,            \
                                _description)
#define FOLLY_GFLAGS_DEFINE_int64(_name, _default, _description)               \
  FOLLY_GFLAGS_DEFINE_FALLBACK_(::std::int64_t, I64, _name, _default,          \
                                _description)
#define FOLLY_GFLAGS_DEFINE_uint32(_name, _default, _description)              \
  FOLLY_GFLAGS_DEFINE_FALLBACK_(::std::uint32_t, U32, _name, _default,         \
                                _description)
#define FOLLY_GFLAGS_DEFINE_uint64(_name, _default, _description)              \
  FOLLY_GFLAGS_DEFINE_FALLBACK_(::std::uint64_t, U64, _name, _default,         \
                                _description)
#define FOLLY_GFLAGS_DEFINE_string(_name, _default, _description)              \
